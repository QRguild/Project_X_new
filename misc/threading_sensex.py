    ...
    def calculate_vwap(self):
        ...
        while True:
            try:
                ...
                # print(f"Last 30-Minute VWAP of Weighted Index: {self.vwap_index_value }")
...
weighted_Sensex_index_vwap = WeightedSensexIndexVWAP(api_key, access_token)
